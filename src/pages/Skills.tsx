  ...
  return (
    <>
      ...
      <div className="skills">
        <SVGDialCircle color="#2dd5ff" text="HTML" value={94} delay={100} />
        <SVGDialCircle color="#2dd5ff" text="CSS" value={92} delay={200} />
        <SVGDialCircle
          color="#2dd5ff"
          text="JavaScript"
          value={77}
        ...
        <SVGDialCircle
          ...
          delay={800}
        />
        <SVGDialCircle color="#2dd5ff" text="Azure" value={68} delay={900} />
        <SVGDialCircle color="#2dd5ff" text="Python" value={72} delay={1000} />
        <SVGDialCircle color="#2dd5ff" text="Angular" value={56} delay={1100} />
        <SVGDialCircle
          color="#2dd5ff"
          text="TypeScript"
          value={60}
